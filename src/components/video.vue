  ...
  <div class="item-box" @click="pause">
    ...
    <div class="item-box__progress" @click.stop="">
      ...
      <div class="progress" @click="handleProgress">
        <div class="progress-buffer" :style="`width:${percentageBuffer}%`"></div>
        <div
          ref="progressSpeed"
    ...
    function progress() {
      ...
      percentageBuffer.value = Math.floor(
        (video.value.buffered.length
          ? video.value.buffered.end(video.value.buffered.length - 1) / video.value.duration
          : 0) * 100
      )
    }
    // 时间改变
...
.item-box {
  ...
  .template-loading {
    ...
    height: 10px;
    border-radius: 50%;
    box-shadow: 28px 0 0 #ff552e, 50px 0 0 #3e80f8, 72px 0 0 #53e7ae, 94px 0 0 #ffce5a;
...
@keyframes spinner-dot {
  20% {
    box-shadow: 28px -10px 0 #ff552e, 50px 0 0 #3e80f8, 72px 0 0 #53e7ae, 94px 0 0 #ffce5a;
  }

  40% {
    box-shadow: 28px 0 0 #ff552e, 50px -10px 0 #3e80f8, 72px 0 0 #53e7ae, 94px 0 0 #ffce5a;
  }

  60% {
    box-shadow: 28px 0 0 #ff552e, 50px 0 0 #3e80f8, 72px -10px 0 #53e7ae, 94px 0 0 #ffce5a;
  }

  80% {
    box-shadow: 28px 0 0 #ff552e, 50px 0 0 #3e80f8, 72px 0 0 #53e7ae, 94px -10px 0 #ffce5a;
  }
}
</style>
